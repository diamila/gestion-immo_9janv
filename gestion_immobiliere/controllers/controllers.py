...
class Todo(http.Controller):
    ...
    def hello(self, **kw):
        ...
        return request.render("gestion_immobiliere.hello")
...
class Main(http.Controller):
    ...
    def index(self, **kw):
        ...
        return request.render("gestion_immobiliere.index", {'product': products})

       
class Main_detail(http.Controller):
    @http.route('/todo/<model("product.product"):task>', website=True)
    def index(self, task, **kw):
        return http.request.render('gestion_immobiliere.detail',{'product': task})
